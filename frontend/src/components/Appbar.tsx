        ...
        <div className="border-b flex justify-between items-center px-4 sm:px-6 lg:px-10 py-4">
            ...
            <div className="flex items-center space-x-4">
                <Link to={`/my-blogs`}>
                    <button 
                        type="button" 
                        className="text-gray-700 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-4 sm:px-5 py-2 text-center transition-colors duration-200"
                    >
                        My Blogs
                    </button>
                </Link>
